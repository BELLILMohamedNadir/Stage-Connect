...
@Composable
fun RecruiterBottomNavigationBar(navController: NavController, modifier: Modifier = Modifier) {
    ...
    val items = listOf(
        ...
        Triple(
            painterResource(id = R.drawable.ic_company_bottom_navigation),
