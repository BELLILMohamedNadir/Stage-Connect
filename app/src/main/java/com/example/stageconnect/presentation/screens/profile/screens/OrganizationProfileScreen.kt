        ...
        Column(
            ...
            AppButton(
                ...
                if(user.role == ROLE.RECRUITER){
                    ...
                    if (isValidRecruiterDto_(recruiterDto)) viewModel.updateRecruiter(request = recruiterDto, fileUri = imageUri) else showErrorMessage = true
                }
                else{
                    ...
                    if (isValidEstablishment_(establishmentDto)) viewModel.updateEstablishment(request = establishmentDto, fileUri = imageUri) else showErrorMessage = true
                }
            }
        }
        if (showErrorMessage){
...
fun isValidRecruiterDto_(recruiterDto: RecruiterDto): Boolean {
...
fun isValidEstablishment_(establishmentDto: EstablishmentDto): Boolean {
    return establishmentDto.name!!.isNotBlank() &&
            establishmentDto.firstName!!.isNotBlank() &&
            establishmentDto.dateOfBirth!!.isNotBlank() &&
            establishmentDto.currentPosition!!.isNotBlank()
}